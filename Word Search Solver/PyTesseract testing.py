...
for list in dictofstrings:
    ...
    print("check the order of the letters and if incorrect input the letters with only a space between them")
    print("(Note: if there are any errors the entire line must be re-entered)")
    print("if the entire line should be deleted enter 'DELETE', if the line is correct enter 'GOOD'")
    verify = input()
    verify = verify.upper()
    print(verify)
    if verify == "" :
